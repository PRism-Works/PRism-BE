...
public class PostFacade {
    ...
    public ViewPostResult viewPost(Long postId) {
        ...
        ProjectDetailInfo projectDetailInfo = projectService.getProjectDetailInRetrieve(
            postRecruitmentInfo.getProjectId());

        return new ViewPostResult(postRecruitmentInfo, userDetail, projectDetailInfo);
    }
