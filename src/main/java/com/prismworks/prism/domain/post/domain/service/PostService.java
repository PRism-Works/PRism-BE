...
import com.prismworks.prism.domain.post.domain.repository.PostRepository;
import com.prismworks.prism.domain.post.domain.repository.PostTeamRecruitmentRepository;
import com.prismworks.prism.domain.post.domain.repository.TeamRecruitmentPositionRepository;
